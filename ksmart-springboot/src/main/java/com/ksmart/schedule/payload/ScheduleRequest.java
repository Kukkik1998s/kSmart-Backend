...
public class ScheduleRequest {
    ...
    public ScheduleRequest(Patient patient, User creator, List<Medicine> medicines, Date startDate, int frequency, UnitOfTime unitOfTime, DayOfWeek day, LocalTime time) {
