...
public class PatientInfo {
    ...
    public PatientInfo(String name, String lastname, Date birthdate, String address, String phoneNo, Double weight, Double height, Double gfr, String gender, int ckdPhase) {
        this.name = name;
